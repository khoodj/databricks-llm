...
from src.utils.agents import RAGSQLAgent
from src.prompts.prompt import *
from src.utils.lambda_functions import LambdaFunctions
    ...
    def output_chain(self):
        ...
        agent_chain = (
            RunnablePassthrough.assign(
                ...
                # trimmed_history=itemgetter("history") | trimmer,
